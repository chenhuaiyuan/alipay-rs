...
async fn naive_station_query() {
    ...
    client.request_params.set_alipay_root_cent_sn("alipayRootCert.crt");
    client.request_params.set_app_cert_sn("appCertPublicKey_2021002182623971.crt");
    let data:serde_json::Value = client
